...
Se o seu JS tenta dar um `document.getElementById("botao")` e o script rodar antes do botão ter criado no HTML, ele vai retornar null. O erro mais clássico de quem está começando é tentar manipular algo que o navegador ainda nem sabe que existe.
